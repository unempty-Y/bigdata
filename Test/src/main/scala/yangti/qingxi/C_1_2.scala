...
object C_1_2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data: DataStream[String] = env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks[String], "kafka source")
    ...
    Hbase1.addSink(new writeHbase(bigdata1, "xxxx", "order_master", "info"))
  ...
  private class writeHbase(zookeeper: String, namepace: String, table: String, family: String) extends RichSinkFunction[String] {
    ...
    override def invoke(value: String, context: SinkFunction.Context): Unit = {
      ...
      val rowkey = (str \ "order_master").toString
